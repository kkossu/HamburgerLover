...
public class UIWidget : UIRect
{
...
#else
			return ((panel != null) ? mDepth + panel.depth * 1000 : mDepth) + sortingLayerValue * 1000000;
#endif
		}
	}
	...
	private int sortingLayerValue {
		get
		{
			if (panel && string.IsNullOrEmpty(panel.sortingLayerName) == false)
				return SortingLayer.GetLayerValueFromName(panel.sortingLayerName);
			return 0;
		}
	}
